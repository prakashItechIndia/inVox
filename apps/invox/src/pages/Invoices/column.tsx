...
export const Columns = (): ColumnDef<GetInvoiceResponse>[] => [
  ...
  },
  {
    ...
    header: () => <div className="text-md">Received on</div>,
    cell: ({ row }) => {
      const TimeStampHours = formatTimestampOrHoursLeft(
        row.getValue("receivedon")
      );
      return (
        <div
  ...
  },
  {
    ...
    header: () => <div className="text-md">Processed on</div>,
    cell: ({ row }) => {
      const value = formatTimestampOrHoursLeft(row.getValue("processedon"));
      return (
        <div className="text-blueDark  flex items-center text-md" title={value}>
          {value ? truncateString(value, 14) : "-"}
        </div>
      );
    }
  },
  {
    ...
    header: () => <div className="text-md">Reviewed by</div>,
    cell: ({ row }) => (
      <div className="text-blueDark  flex items-center text-md">
