...
const en = {
  ...
  LOGIN: {
    ...
    SUB_TITLE: 'Automate your document workflow with AI. Instantly extract, structure, and access critical data— so your team can focus on what matters most.',
    USERNAME: 'Username',
    PASSWORD: 'Password',
    LOGIN: 'Login',
  ...
  SETTINGS: {
    ...
    EMAIL: {
      ...
      TITLE: 'Email Server',
      DESCRIPTION: 'Lorem ipsum dolor sit amet consectetur. Orci amet massa aliquam volutpat. Dignissim sit eu mi donec quam massa amet.',
