...
export default {
  ...
  LOGIN: {
    ...
    BANNER_DESCRIPTION: 'Melden Sie sich an, um Zugriff auf intelligente Dokumentenverarbeitung, erhöhte Sicherheit und nahtlose Workflow-Automatisierung zu erhalten.',
